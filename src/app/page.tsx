...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#E3F2FD]">
      ...
      <section className="bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-[#004C97] sm:text-6xl mb-6">
              Calculadora SUNAT
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/sunat-calculator">
                <Button size="lg" className="text-lg px-8 py-6 bg-[#B71C1C] hover:bg-[#C62828] border-0">
                  <Calculator className="mr-2 h-5 w-5" />
                  Calcular Ahora
                </Button>
              </Link>
              <Link href="/documentation">
                <Button variant="outline" size="lg" className="text-lg px-8 py-6 border-[#004C97] text-[#004C97] hover:bg-[#004C97] hover:text-white">
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {stats.map((stat) => (
              <Card key={stat.label} className="text-center border-[#E0E0E0] shadow-sm hover:shadow-md transition-shadow duration-200">
                <CardContent className="pt-6">
                  <div className="text-2xl font-bold text-[#004C97] mb-2">
                    {stat.value}
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {features.map((feature) => (
              <Card key={feature.title} className="hover:shadow-lg transition-shadow duration-200 border-[#E0E0E0] shadow-sm">
                <CardHeader>
                  <div className="flex items-center space-x-3">
                    <div className="p-2 bg-[#E3F2FD] rounded-lg">
                      <feature.icon className="h-6 w-6 text-[#004C97]" />
                    </div>
                    <CardTitle className="text-xl text-[#004C97]">{feature.title}</CardTitle>
                  </div>
                </CardHeader>
                <CardContent>
                  ...
                  <Link href={feature.href} className="inline-flex items-center text-[#1976D2] hover:text-[#004C97] mt-4 font-medium transition-colors duration-200">
      ...
      {/* CTA Section */}
      <section className="py-16 bg-[#004C97]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">
            ¿Listo para optimizar tus impuestos?
          </h2>
          <p className="text-xl text-[#E3F2FD] mb-8 max-w-2xl mx-auto">
            Únete a miles de usuarios que ya confían en nuestra calculadora SUNAT para gestionar sus obligaciones fiscales
          </p>
          <Link href="/sunat-calculator">
            <Button size="lg" variant="secondary" className="text-lg px-8 py-6 bg-[#B71C1C] hover:bg-[#C62828] border-0 text-white">
              <Calculator className="mr-2 h-5 w-5" />
              Comenzar Ahora
            </Button>
          </Link>
      ...
      <footer className="bg-[#333333] text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                <div className="bg-[#004C97] p-2 rounded-lg">
                  <Image 
                    src="/logo.png" 
                    alt="SUNAT Logo" 
                    width={32} 
                ...
                <span className="text-xl font-bold">SUNAT</span>
              </div>
          ...
          <div className="border-t border-[#666666] mt-8 pt-8 text-center text-[#E0E0E0]">
            <p>&copy; 5 SUNAT. Todos los derechos reservados.</p>
          </div>
        </div>
      </footer>
    </div>
